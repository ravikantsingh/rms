...
/////////////////////////////////////////Fetch Part//////////////////////////////////////////////////////
if( isset($_GET['id']) ){
    $data = getTaxDataSingle( $dbh, $_GET['id'] );
    if( $data ){
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="flot-big-container">
                    <form action="./?option=editTax<?php echo '&id='.$_GET['id']; ?>" role="form" class="smart-wizard form-horizontal" method="post" name="site_config"  enctype="multipart/form-data" accept-charset="utf-8" novalidate>
