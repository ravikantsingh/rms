...
/////////////////////////////////////////Fetch Part//////////////////////////////////////////////////////
if( isset($_GET['id']) ){
    $data = getCategoryDataSingle( $dbh, $_GET['id'] );
    if( $data ){
        foreach( $data as $key => $value ){
            $$key = $value;
        }
    }
    $catData = getCategoryOptions( $dbh, $parent );
}
//////////////////////////////////////////////////////////////////////////////////////////////////
?>
<div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="flot-big-container">
                    <form action="./?option=editCategory<?php echo '&id='.$_GET['id']; ?>" role="form" class="smart-wizard form-horizontal" method="post" name="site_config"  enctype="multipart/form-data" accept-charset="utf-8" novalidate>
                        <div class="form-group">
                          <label class="col-sm-2 control-label" for="co_name">Name:<font color="#ff0000">*</font> </label>
                          <div class="col-sm-3">
                            <input class="form-control" type="text" name="category" autocomplete="Off" tabindex="1" value="<?php echo $category;?>">
                          </div>
                        </div>
												<div class="form-group">
