...
<!-- start: HEAD --><!--[if IE 8]><html class="ie8 no-js" lang="en"><![endif]--><!--[if IE 9]><html class="ie9 no-js" lang="en"><![endif]-->
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title><?php echo $college['name'].' | Admin | '.splitWord(ucfirst($option)); ?></title>
	<!-- start: META -->
	...
	<style type="text/css" id="less:backoffice-public_html-css-styles">
	/* colors */
	...
	<link rel="stylesheet/less" type="text/css" href="./css/animations.css">
	<style type="text/css" id="less:backoffice-public_html-css-animations">
	.slideDown {
	...
	.bigEntrance {
	  ...
	  -webkit-animation-duration: 1.6s;
	  animation-timing-function: ease-out;
	  -w	ebkit-animation-timing-function: ease-out;
	  visibility: visible !important;
	}
