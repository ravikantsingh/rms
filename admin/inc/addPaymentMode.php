        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="flot-big-container">
                    <form action="./?option=addPaymentMode" role="form" class="smart-wizard form-horizontal" method="post" name="site_config"  enctype="multipart/form-data" accept-charset="utf-8" novalidate>
                        <div class="form-group">
                          <label class="col-sm-2 control-label" for="co_name">Payment Mode:<font color="#ff0000">*</font> </label>
                          <div class="col-sm-3">
                            <input class="form-control" type="text" name="pmode" autocomplete="Off" tabindex="1" value="">
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <div class="col-sm-5 text-right">
                            ...
                            <input class="btn btn-success" type="submit" name="submit" value="Add Payment Mode">
                          </div>
                        </div>
                    </form>
                </div>
