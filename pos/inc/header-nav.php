  ...
  <div class="container">
    ...
    <div class="navbar-tools">
      <ul class="nav navbar-right">
        ...
        <li class="dropdown"> <a data-toggle="dropdown" class="dropdown-toggle" href="#" aria-expanded="true"> <img alt="" src="<?php echo ( isset( $result['profile'] ) && $result['profile']!='')?$result['profile']:HOST.'img/nophoto.jpg'; ?>" height="30px" width="30px"> <span class="username"><?php echo ucfirst($result['name']); ?></span> <b class="caret"></b> </a>
