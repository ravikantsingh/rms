        	...
        	<div class="container" style="border: none;">
        	    <div class="row">
        	        <div class="cart">
        	            ...
        	            <span style="right: 50px; top: 5px; position: absolute; font-size: 18px;">Payable Amount: Rs. <span id="payable-amount"><?php echo $payable; ?></span></span>
        	            <span style="right: 50px; top: 30px; position: absolute; font-size: 18px;">Remaining Amount: Rs. <input type="text" readonly class="btn btn-link" id = "payable" value="<?php echo $payable; ?>" size="4" /> </span>
        	        </div>
        	    </div>
